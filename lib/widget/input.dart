...
class InputWidget extends StatelessWidget{
  ...
  InputWidget({this.hint,this.inputFormatters,this.atuoFocus=false,this.controller,this.enable=true,this.maxLenth,this.onChange,this.margin,this.prefix,this.postfix,this.fontStyle,this.hideText=false,this.inputType,this.textCapitalization});
